-- Add jobs.long_description to Job Summary CSV export rows.
...
returns table (
  job_id uuid, job_description text, long_description text, customer_name text, service_address text,
...
as $$
  ...
  select j.id, j.short_description, j.long_description, j.customer_name, j.service_address,
